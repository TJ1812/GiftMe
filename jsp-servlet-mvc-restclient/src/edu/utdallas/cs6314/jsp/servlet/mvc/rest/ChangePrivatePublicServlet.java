 ...
 */
@WebServlet("/ChangePrivatePublicServlet")
public class ChangePrivatePublicServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ChangePrivatePublicServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pub = keyJson.getString("public").toString();
		System.out.println(registryId);
		try {
			Client client = Client.create();
			WebResource webResource = client.resource("http://localhost:8080/jaxrs-jersey-rest/changeprivatepublicservices/changeprivatepublic");
			MultivaluedMap<String, String> formData = new MultivaluedMapImpl();
			formData.add("registryId", registryId);
			formData.add("pub", pub);
