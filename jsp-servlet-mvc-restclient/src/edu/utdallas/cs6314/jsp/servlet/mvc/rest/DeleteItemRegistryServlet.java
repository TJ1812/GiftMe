 ...
 */
@WebServlet("/DeleteItemRegistryServlet")
public class DeleteItemRegistryServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DeleteItemRegistryServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		itemId = keyJson.getString("itemId").toString();
		System.out.println(registryId);
		try {
			Client client = Client.create();
			WebResource webResource = client.resource("http://localhost:8080/jaxrs-jersey-rest/deleteitemregistryservices/deleteitemregistry");
