 ...
 */
@WebServlet("/RetrieveItemServlet")
public class RetrieveItemServlet extends HttpServlet {
	 ...
	 */
	public RetrieveItemServlet() throws IOException {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			WebResource webResource = client
					.resource("http://localhost:8080/jaxrs-jersey-rest/retrieveitemservices/retrieveitem");
